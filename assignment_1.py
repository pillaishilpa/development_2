...
zero_cent_expected_result=['0,00','12,00','1.234,00','1.234.567.890,00','345.677,00','1.233.678,00']
number_only_expected_result=['1233','-1234','12343','','1234','12323455']

def test_case(id,cases,driver):
	case_result=[]
	phone_case_result=[]
	zero_cent_cases_result=[]
	only_number_case_result=[]
